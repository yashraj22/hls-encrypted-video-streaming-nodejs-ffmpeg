...
export class VideoController {
  ...
  static async getEncryptionKey(req: AuthRequest, res: Response): Promise<void> {
    try {
  ...
  static async getVideoPlaylist(req: AuthRequest, res: Response): Promise<void> {
    try {
  ...
  // Get video thumbnail
  static async getVideoThumbnail(req: AuthRequest, res: Response): Promise<void> {
    try {
      const { lessonId } = req.params;
  ...
  static async generateVideoToken(req: AuthRequest, res: Response): Promise<void> {
    try {
      const { lessonId } = req.params;
      const userId = req.user?.id;
